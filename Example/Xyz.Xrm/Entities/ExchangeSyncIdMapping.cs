...
namespace Xyz.Xrm.Entities
{
	...
	public partial class ExchangeSyncIdMapping : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public Xyz.Xrm.Entities.BusinessUnit business_unit_exchangesyncidmapping
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Xyz.Xrm.Entities.BusinessUnit>("business_unit_exchangesyncidmapping", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("business_unit_exchangesyncidmapping");
				this.SetRelatedEntity<Xyz.Xrm.Entities.BusinessUnit>("business_unit_exchangesyncidmapping", null, value);
		...
		public Xyz.Xrm.Entities.Team team_exchangesyncidmapping
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Xyz.Xrm.Entities.Team>("team_exchangesyncidmapping", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("team_exchangesyncidmapping");
				this.SetRelatedEntity<Xyz.Xrm.Entities.Team>("team_exchangesyncidmapping", null, value);
		...
		public Xyz.Xrm.Entities.SystemUser user_exchangesyncidmapping
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Xyz.Xrm.Entities.SystemUser>("user_exchangesyncidmapping", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("user_exchangesyncidmapping");
				this.SetRelatedEntity<Xyz.Xrm.Entities.SystemUser>("user_exchangesyncidmapping", null, value);
