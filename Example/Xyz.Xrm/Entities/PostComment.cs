...
namespace Xyz.Xrm.Entities
{
	...
	public partial class PostComment : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public Xyz.Xrm.Entities.SystemUser lk_postcomment_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Xyz.Xrm.Entities.SystemUser>("lk_postcomment_createdby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_postcomment_createdby");
				this.SetRelatedEntity<Xyz.Xrm.Entities.SystemUser>("lk_postcomment_createdby", null, value);
		...
		public Xyz.Xrm.Entities.SystemUser lk_postcomment_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Xyz.Xrm.Entities.SystemUser>("lk_postcomment_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_postcomment_createdonbehalfby");
				this.SetRelatedEntity<Xyz.Xrm.Entities.SystemUser>("lk_postcomment_createdonbehalfby", null, value);
		...
		public Xyz.Xrm.Entities.Organization organization_PostComment
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Xyz.Xrm.Entities.Organization>("organization_PostComment", null);
			}
		}
		...
		public Xyz.Xrm.Entities.Post Post_Comments
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Xyz.Xrm.Entities.Post>("Post_Comments", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("Post_Comments");
				this.SetRelatedEntity<Xyz.Xrm.Entities.Post>("Post_Comments", null, value);
