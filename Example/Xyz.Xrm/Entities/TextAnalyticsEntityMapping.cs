...
namespace Xyz.Xrm.Entities
{
	...
	public partial class TextAnalyticsEntityMapping : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public Xyz.Xrm.Entities.KnowledgeSearchModel knowledgesearchmodel_textanalyticsentitymapping
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Xyz.Xrm.Entities.KnowledgeSearchModel>("knowledgesearchmodel_textanalyticsentitymapping", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("knowledgesearchmodel_textanalyticsentitymapping");
				this.SetRelatedEntity<Xyz.Xrm.Entities.KnowledgeSearchModel>("knowledgesearchmodel_textanalyticsentitymapping", null, value);
		...
		public Xyz.Xrm.Entities.Organization organization_textanalyticsentitymapping
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Xyz.Xrm.Entities.Organization>("organization_textanalyticsentitymapping", null);
			}
		}
		...
		public Xyz.Xrm.Entities.SimilarityRule similarityrule_textanalyticsentitymapping
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Xyz.Xrm.Entities.SimilarityRule>("similarityrule_textanalyticsentitymapping", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("similarityrule_textanalyticsentitymapping");
				this.SetRelatedEntity<Xyz.Xrm.Entities.SimilarityRule>("similarityrule_textanalyticsentitymapping", null, value);
		...
		public Xyz.Xrm.Entities.TopicModelConfiguration topicmodelconfiguration_textanalyticsentitymapping
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Xyz.Xrm.Entities.TopicModelConfiguration>("topicmodelconfiguration_textanalyticsentitymapping", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("topicmodelconfiguration_textanalyticsentitymapping");
				this.SetRelatedEntity<Xyz.Xrm.Entities.TopicModelConfiguration>("topicmodelconfiguration_textanalyticsentitymapping", null, value);
