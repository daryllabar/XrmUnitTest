...
#endif
{
    public static partial class Extensions
    {
        ...
        /// <returns></returns>
        public static byte[] DownloadFile(this IOrganizationService service, EntityReference entityReference, string attributeName)
        {
            var initializeFileBlocksDownloadResponse = (InitializeFileBlocksDownloadResponse)service.Execute(new InitializeFileBlocksDownloadRequest
            {
            ...
            {
                var downloadBlockResponse = (DownloadBlockResponse)service.Execute(new DownloadBlockRequest
                {
        ...
        public static CommitFileBlocksUploadResponse UploadFile(this IOrganizationService service, EntityReference entityReference, string fileAttributeName, FileInfo fileInfo, string fileMimeType = null)
        {
            ...
            {
                return UploadStream(service, fileInfo.Name, uploadFileStream, initResponse.FileContinuationToken, fileMimeType);
            }
        }
        ...
        private static CommitFileBlocksUploadResponse UploadStream(IOrganizationService service, string fileName, Stream uploadFileStream, string fileContinuationToken, string fileMimeType)
        {
            ...
            return (CommitFileBlocksUploadResponse)service.Execute(new CommitFileBlocksUploadRequest
            {
        ...
        public static CommitFileBlocksUploadResponse UploadFile(this IOrganizationService service, EntityReference entityReference, string fileAttributeName, string fileName, byte[] fileData, string fileMimeType = null)
        {
            ...
            {
                return UploadStream(service, fileName, uploadMemoryStream, initResponse.FileContinuationToken, fileMimeType);
            }
        }
        ...
        /// </summary>
        /// <remarks>https://github.com/dotnet/aspnetcore/blob/3f1acb59718cadf111a0a796681e3d3509bb3381/src/Middleware/StaticFiles/src/FileExtensionContentTypeProvider.cs</remarks>
        private class InternalFileExtensionContentTypeProvider
        {
            /// <summary>
            /// Creates a new provider with a set of default mappings.
            /// </summary>
            public InternalFileExtensionContentTypeProvider()
            {
